...
# Create Reliance stock price plot
...
ax.plot(df['Date'], df['Close'], label='Relaince stock')
ax.set(xlabel="Date",
       ylabel="USD",
...
def plot_technical_indicators(dataset, last_days):
       ...
       plt.title('Technical indicators for Reliance - last {} days.'.format(last_days))
       plt.ylabel('USD')
       plt.legend()
...
def plot_Fourier(dataset):
    ...
    plt.xlabel('Days')
    plt.ylabel('USD')
    plt.title('Reliance (close) stock prices & Fourier transforms')
    plt.legend()
    plt.show()
